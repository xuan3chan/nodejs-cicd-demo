...
let SeedService = SeedService_1 = class SeedService {
    ...
    constructor(menuRepository, adminRepository, configRepository) {
    ...
    async seedAdmin() {
        ...
        this.logger.log('Default admin created: username=admin, password=Admin@123');
    }
    async seedMenu() {
        ...
        this.logger.log(`Seeded ${initialMenuItems.length} menu items successfully.`);
    }
    async seedSiteConfig() {
        ...
        const defaults = [
            {
                ...
                value: {
                    ...
                    description: 'Nơi hội tụ tinh hoa ẩm thực Việt Nam và quốc tế trong không gian thanh lịch, mang đến cho bạn những khoảnh khắc đáng nhớ bên gia đình và bạn bè.',
            ...
            },
            {
                ...
                value: {
                    ...
                    paragraph1: 'Được thành lập từ niềm đam mê với ẩm thực Việt Nam, Azure Kitchen là nơi giao thoa giữa truyền thống và hiện đại. Mỗi món ăn là một câu chuyện, được chế biến từ những nguyên liệu tươi ngon nhất, theo công thức gia truyền đã được gìn giữ qua nhiều thế hệ.',
                    paragraph2: 'Không gian nhà hàng được thiết kế tinh tế với tông xanh dương nhẹ nhàng, mang đến cảm giác thư thái và thanh lịch cho mỗi bữa ăn của bạn.',
            ...
            },
            {
                ...
                value: {
                    ...
                    subtitle: 'Khám phá không gian ấm cúng và những món ăn tuyệt vời tại Azure Kitchen',
                    images: [
            ...
            },
            {
                key: 'footer',
                value: {
                    brandDesc: 'Nơi hội tụ tinh hoa ẩm thực trong không gian thanh lịch. Chúng tôi mang đến trải nghiệm ẩm thực đáng nhớ cho mỗi thực khách.',
        ...
        this.logger.log(`Seeded ${defaults.length} site config entries successfully.`);
    }
};
...
exports.SeedService = SeedService = SeedService_1 = __decorate([
    ...
    __param(2, (0, typeorm_1.InjectRepository)(site_config_entity_1.SiteConfigEntity)),
